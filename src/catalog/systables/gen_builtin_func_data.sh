...
#define BUILTIN_ARGTYPE(...) \
    'funcargs': IF_EMPTY(CAR(__VA_ARGS__), [], ([ MAP_LIST(PARSE_ARG_TYPE, __VA_ARGS__) ]) ),
#define BUILTIN_OPR(...) \
...
castout = open('""${OUTDIR}""/Cast.dat', 'w')
castout.write('// Data file for the Cast catalog\n')
castout.write('// This is a file to be included into a python file using a C/C++\n')
castout.write('// preprocessor.')
castout.write('// This file is automatically generated, do NOT modify.')
...
for func in func_list:
    ...
    if 'optypes' in func:
        for optype in func['optypes']:
            if optype == OPTYPE_IMPLICIT_CAST or optype == OPTYPE_CAST:
                castout.write('\n{{\n    castfuncid: {}, castoprtypid: {}, castrettypid: {}, castisimplicit: {}\n}},\n'.format(
                func[funcid],
                (len(func['funcargs']) == 1 and func['funcargs'][0] or 'INVALID_CAST'),
                func[funcrettypid],
                optype == OPTYPE_IMPLICIT_CAST and 'true' or 'false'))
            else:
